<?php
if ( ! function_exists( 'entropia_edge_init_google_fonts_array' ) ) {
    function entropia_edge_init_google_fonts_array() {
        ...
        $entropia_edge_global_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'entropia_edge_init_google_fonts_array');
}