...
namespace EntropiaCore\Lib;

/**
 * Class ShortcodeLoader
 * @package EntropiaCore\Lib
 */
class ShortcodeLoader {
	/**
	...
	private function addShortcodes() {
		$shortcodes_class_name = apply_filters( 'entropia_core_filter_add_vc_shortcode', $shortcodes_class_name = array() );
