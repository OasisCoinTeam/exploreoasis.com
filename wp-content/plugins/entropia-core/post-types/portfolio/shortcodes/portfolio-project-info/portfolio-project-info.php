...
class PortfolioProjectInfo implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Portfolio Project Info', 'entropia-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						array(
							...
							'heading'     => esc_html__( 'Selected Project', 'entropia-core' ),
							'settings'    => array(
								'sortable'      => true,
								'unique_values' => true
							),
							'description' => esc_html__( 'If you left this field empty then project ID will be of the current page', 'entropia-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'project_info_type',
							'heading'     => esc_html__( 'Project Info Type', 'entropia-core' ),
							'value'       => array(
								esc_html__( 'Title', 'entropia-core' )          => 'title',
								esc_html__( 'Category', 'entropia-core' )       => 'category',
								esc_html__( 'Tag', 'entropia-core' )            => 'tag',
								esc_html__( 'Author', 'entropia-core' )         => 'author',
								esc_html__( 'Date', 'entropia-core' )           => 'date',
								esc_html__( 'Featured Image', 'entropia-core' ) => 'image'
							),
							'admin_label' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Project Title Tag', 'entropia-core' ),
							'value'       => array_flip( entropia_edge_get_title_tag( true, array( 'p' => 'p' ) ) ),
							'description' => esc_html__( 'Set title tag for project title element', 'entropia-core' ),
							'dependency'  => array( 'element' => 'project_info_type', 'value' => array( 'title' ) )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'project_info_title',
							'heading'     => esc_html__( 'Project Info Label', 'entropia-core' ),
							'description' => esc_html__( 'Add project info label before project info element/s', 'entropia-core' )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'project_info_title_tag',
							'heading'    => esc_html__( 'Project Info Label Tag', 'entropia-core' ),
							'value'      => array_flip( entropia_edge_get_title_tag( true, array( 'p' => 'p' ) ) ),
