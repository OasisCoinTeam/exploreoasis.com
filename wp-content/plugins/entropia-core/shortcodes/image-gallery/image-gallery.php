<?php
namespace EntropiaCore\CPT\Shortcodes\ImageGallery;
...
class ImageGallery implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Image Gallery', 'entropia-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'type',
							'heading'     => esc_html__( 'Gallery Type', 'entropia-core' ),
							'value'       => array(
								esc_html__( 'Image Grid', 'entropia-core' ) => 'grid',
								esc_html__( 'Masonry', 'entropia-core' )    => 'masonry',
								esc_html__( 'Slider', 'entropia-core' )     => 'slider',
								esc_html__( 'Carousel', 'entropia-core' )   => 'carousel'
							),
							'save_always' => true,
							'admin_label' => true
						),
						array(
							'type'        => 'attach_images',
							'param_name'  => 'images',
							'heading'     => esc_html__( 'Images', 'entropia-core' ),
							'description' => esc_html__( 'Select images from media library', 'entropia-core' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'image_size',
							'heading'     => esc_html__( 'Image Size', 'entropia-core' ),
							'description' => esc_html__( 'Enter image size. Example: thumbnail, medium, large, full or other sizes defined by current theme. Alternatively enter image size in pixels: 200x100 (Width x Height). Leave empty to use "full" size', 'entropia-core' )
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'heading'    => esc_html__( 'Image Behavior', 'entropia-core' ),
							'value'      => array(
								esc_html__( 'None', 'entropia-core' )             => '',
								esc_html__( 'Open Lightbox', 'entropia-core' )    => 'lightbox',
								esc_html__( 'Open Custom Link', 'entropia-core' ) => 'custom-link',
								esc_html__( 'Zoom', 'entropia-core' )             => 'zoom',
								esc_html__( 'Grayscale', 'entropia-core' )        => 'grayscale'
							)
						),
						array(
							'type'        => 'textarea',
							'param_name'  => 'custom_links',
							'heading'     => esc_html__( 'Custom Links', 'entropia-core' ),
							'description' => esc_html__( 'Delimit links by comma', 'entropia-core' ),
							'dependency'  => array( 'element' => 'image_behavior', 'value' => array( 'custom-link' ) )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'custom_link_target',
							'heading'    => esc_html__( 'Custom Link Target', 'entropia-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Padding', 'entropia-core' ),
							'description' => esc_html__( 'Padding left and right on stage (can see neighbours).', 'entropia-core' ),
							'value'       => array_flip( entropia_edge_get_yes_no_select_array( false ) ),
							'save_always' => true,
	...
	public function render( $atts, $content = null ) {
		...
		$html = entropia_core_get_shortcode_module_template_part( 'templates/' . $params['type'], 'image-gallery', '', $params );
