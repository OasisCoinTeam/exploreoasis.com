...
include 'entropia-instagram-helper.php';

/**
 * Class EntropiaInstagramApi
 */
class EntropiaInstagramApi {
	/**
	...
	private $apiURL;
	/**
	 * @var EntropiaInstagramApi instance of current class
	 */
	private static $instance;
	
	/**
	 * Helper object
	 * @var EntropiaInstagramHelper
	 */
	private $helper;
	
	const CODE_OPTION_NAME = 'entropia_instagram_code';
	const USER_ID_OPTION_NAME = 'entropia_instagram_user_id';
	const ACCESS_TOKEN_OPTION_NAME = 'entropia_instagram_access_token';
	const CODE_REDIRECT_URI_OPTION_NAME = 'entropia_instagram_code_redirect_uri';
	...
	public function __construct() {
		...
		$this->helper       = new EntropiaInstagramHelper();
	}
	 ...
	 * @return string
	 *
	 * @see EntropiaInstagramApi::buildCurrentPageURI()
	 */
	...
	/**
	 * @return EntropiaInstagramHelper
	 */
	 ...
	 *
	 * @see EntropiaInstagramApi::fetchData()
	 */
	 ...
	 * @return stdClass
	 *
	 * @see EntropiaInstagramApi::getAccessToken()
	 */
