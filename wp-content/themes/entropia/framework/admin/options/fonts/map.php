...
if ( ! function_exists( 'entropia_edge_fonts_options_map' ) ) {
	/**
	 * Font options page
	 */
	function entropia_edge_fonts_options_map() {
		
		entropia_edge_add_admin_page(
			array(
				'slug'  => '_fonts_page',
				'title' => esc_html__( 'Fonts', 'entropia' ),
				'icon'  => 'fa fa-font'
			)
		);
		 ...
		 * Headings
		 */
		$panel_headings = entropia_edge_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_headings',
				'title' => esc_html__( 'Headings', 'entropia' )
			)
		);
		
		//H1
		$group_heading_h1 = entropia_edge_add_admin_group(
			array(
				'name'        => 'group_heading_h1',
				'title'       => esc_html__( 'H1 Style', 'entropia' ),
				'description' => esc_html__( 'Define styles for h1 heading', 'entropia' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h1_1 = entropia_edge_add_admin_row(
			array(
		...
		entropia_edge_add_admin_field(
			array(
				...
				'args'          => array(
					'suffix' => esc_html__( 'px / em', 'entropia' )
				),
				'parent'        => $row_heading_h1_1
			)
		);
		...
		$row_heading_h1_2 = entropia_edge_add_admin_row(
			array(
		...
		$row_heading_h1_3 = entropia_edge_add_admin_row(
			array(
		...
		entropia_edge_add_admin_field(
			array(
				...
				'name'          => 'h1_margin_top',
				'default_value' => '',
				'label'         => esc_html__( 'Margin Top (px)', 'entropia' ),
		...
		entropia_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Bottom (px)', 'entropia' ),
				'parent'        => $row_heading_h1_3
			)
		);
		
		//H2
		$group_heading_h2 = entropia_edge_add_admin_group(
			array(
				'name'        => 'group_heading_h2',
				'title'       => esc_html__( 'H2 Style', 'entropia' ),
				'description' => esc_html__( 'Define styles for h2 heading', 'entropia' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h2_1 = entropia_edge_add_admin_row(
			array(
		...
		$row_heading_h2_2 = entropia_edge_add_admin_row(
			array(
		...
		$row_heading_h2_3 = entropia_edge_add_admin_row(
			array(
		...
		//H3
		$group_heading_h3 = entropia_edge_add_admin_group(
			array(
				'name'        => 'group_heading_h3',
				'title'       => esc_html__( 'H3 Style', 'entropia' ),
				'description' => esc_html__( 'Define styles for h3 heading', 'entropia' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h3_1 = entropia_edge_add_admin_row(
			array(
		...
		$row_heading_h3_2 = entropia_edge_add_admin_row(
			array(
		...
		$row_heading_h3_3 = entropia_edge_add_admin_row(
			array(
		...
		//H4
		$group_heading_h4 = entropia_edge_add_admin_group(
			array(
				'name'        => 'group_heading_h4',
				'title'       => esc_html__( 'H4 Style', 'entropia' ),
				'description' => esc_html__( 'Define styles for h4 heading', 'entropia' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h4_1 = entropia_edge_add_admin_row(
			array(
		...
		$row_heading_h4_2 = entropia_edge_add_admin_row(
			array(
		...
		$row_heading_h4_3 = entropia_edge_add_admin_row(
			array(
		...
		//H5
		$group_heading_h5 = entropia_edge_add_admin_group(
			array(
				'name'        => 'group_heading_h5',
				'title'       => esc_html__( 'H5 Style', 'entropia' ),
				'description' => esc_html__( 'Define styles for h5 heading', 'entropia' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h5_1 = entropia_edge_add_admin_row(
			array(
		...
		$row_heading_h5_2 = entropia_edge_add_admin_row(
			array(
		...
		$row_heading_h5_3 = entropia_edge_add_admin_row(
			array(
		...
		//H6
		$group_heading_h6 = entropia_edge_add_admin_group(
			array(
				'name'        => 'group_heading_h6',
				'title'       => esc_html__( 'H6 Style', 'entropia' ),
				'description' => esc_html__( 'Define styles for h6 heading', 'entropia' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h6_1 = entropia_edge_add_admin_row(
			array(
		...
		$row_heading_h6_2 = entropia_edge_add_admin_row(
			array(
		...
		$row_heading_h6_3 = entropia_edge_add_admin_row(
			array(
		 ...
		 */
		$panel_responsive_headings3 = entropia_edge_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_responsive_headings3',
				'title' => esc_html__( 'Headings Responsive (Tablet Landscape View)', 'entropia' )
			)
		);
		
		//H1
		$group_responsive3_heading_h1 = entropia_edge_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h1',
				'title'       => esc_html__( 'H1 Responsive Style', 'entropia' ),
				'description' => esc_html__( 'Define responsive styles for h1 heading', 'entropia' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h1_3 = entropia_edge_add_admin_row(
			array(
		...
		//H2
		$group_responsive3_heading_h2 = entropia_edge_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h2',
				'title'       => esc_html__( 'H2 Responsive Style', 'entropia' ),
				'description' => esc_html__( 'Define responsive styles for h2 heading', 'entropia' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h2_3 = entropia_edge_add_admin_row(
			array(
		...
		//H3
		$group_responsive3_heading_h3 = entropia_edge_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h3',
				'title'       => esc_html__( 'H3 Responsive Style', 'entropia' ),
				'description' => esc_html__( 'Define responsive styles for h3 heading', 'entropia' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h3_3 = entropia_edge_add_admin_row(
			array(
		...
		//H4
		$group_responsive3_heading_h4 = entropia_edge_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h4',
				'title'       => esc_html__( 'H4 Responsive Style', 'entropia' ),
				'description' => esc_html__( 'Define responsive styles for h4 heading', 'entropia' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h4_3 = entropia_edge_add_admin_row(
			array(
		...
		//H5
		$group_responsive3_heading_h5 = entropia_edge_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h5',
				'title'       => esc_html__( 'H5 Responsive Style', 'entropia' ),
				'description' => esc_html__( 'Define responsive styles for h5 heading', 'entropia' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h5_3 = entropia_edge_add_admin_row(
			array(
		...
		//H6
		$group_responsive3_heading_h6 = entropia_edge_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h6',
				'title'       => esc_html__( 'H6 Responsive Style', 'entropia' ),
				'description' => esc_html__( 'Define responsive styles for h6 heading', 'entropia' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h6_3 = entropia_edge_add_admin_row(
			array(
		 ...
		 */
		$panel_responsive_headings = entropia_edge_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_responsive_headings',
				'title' => esc_html__( 'Headings Responsive (Tablet Portrait View)', 'entropia' )
			)
		);
		
		//H1
		$group_responsive_heading_h1 = entropia_edge_add_admin_group(
			array(
		...
		$row_responsive_heading_h1_1 = entropia_edge_add_admin_row(
			array(
		...
		//H2
		$group_responsive_heading_h2 = entropia_edge_add_admin_group(
			array(
		...
		$row_responsive_heading_h2_1 = entropia_edge_add_admin_row(
			array(
		...
		//H3
		$group_responsive_heading_h3 = entropia_edge_add_admin_group(
			array(
		...
		$row_responsive_heading_h3_1 = entropia_edge_add_admin_row(
			array(
		...
		//H4
		$group_responsive_heading_h4 = entropia_edge_add_admin_group(
			array(
		...
		$row_responsive_heading_h4_1 = entropia_edge_add_admin_row(
			array(
		...
		//H5
		$group_responsive_heading_h5 = entropia_edge_add_admin_group(
			array(
		...
		$row_responsive_heading_h5_1 = entropia_edge_add_admin_row(
			array(
		...
		//H6
		$group_responsive_heading_h6 = entropia_edge_add_admin_group(
			array(
		...
		$row_responsive_heading_h6_1 = entropia_edge_add_admin_row(
			array(
		 ...
		 */
		$panel_responsive_headings2 = entropia_edge_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_responsive_headings2',
				'title' => esc_html__( 'Headings Responsive (Mobile Devices)', 'entropia' )
			)
		);
		
		//H1
		$group_responsive2_heading_h1 = entropia_edge_add_admin_group(
			array(
		...
		$row_responsive2_heading_h1_1 = entropia_edge_add_admin_row(
			array(
		...
		//H2
		$group_responsive2_heading_h2 = entropia_edge_add_admin_group(
			array(
		...
		$row_responsive2_heading_h2_1 = entropia_edge_add_admin_row(
			array(
		...
		//H3
		$group_responsive2_heading_h3 = entropia_edge_add_admin_group(
			array(
		...
		$row_responsive2_heading_h3_1 = entropia_edge_add_admin_row(
			array(
		...
		//H4
		$group_responsive2_heading_h4 = entropia_edge_add_admin_group(
			array(
		...
		$row_responsive2_heading_h4_1 = entropia_edge_add_admin_row(
			array(
		...
		//H5
		$group_responsive2_heading_h5 = entropia_edge_add_admin_group(
			array(
		...
		$row_responsive2_heading_h5_1 = entropia_edge_add_admin_row(
			array(
		...
		//H6
		$group_responsive2_heading_h6 = entropia_edge_add_admin_group(
			array(
		...
		$row_responsive2_heading_h6_1 = entropia_edge_add_admin_row(
			array(
		 ...
		 * Text
		 */
		$panel_text = entropia_edge_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_text',
		...
		$group_text = entropia_edge_add_admin_group(
			array(
				'name'        => 'group_text',
				'title'       => esc_html__( 'Paragraph', 'entropia' ),
				'description' => esc_html__( 'Define styles for paragraph text', 'entropia' ),
				'parent'      => $panel_text
			)
		);
		
		$row_text_1 = entropia_edge_add_admin_row(
			array(
				'name'   => 'row_text_1',
				'parent' => $group_text
			)
		...
		$row_text_2 = entropia_edge_add_admin_row(
			array(
				'name'   => 'row_text_2',
				'parent' => $group_text,
				'next'   => true
		...
		$row_text_3 = entropia_edge_add_admin_row(
			array(
				'name'   => 'row_text_3',
				'parent' => $group_text,
				'next'   => true
		...
		$group_text_res1 = entropia_edge_add_admin_group(
			array(
				'name'        => 'group_text_res1',
				'title'       => esc_html__( 'Paragraph Responsive (Tablet Portrait View)', 'entropia' ),
				'description' => esc_html__( 'Define responsive styles for paragraph text for tablet devices - portrait view', 'entropia' ),
				'parent'      => $panel_text
			)
		);
		
		$row_res_text_1 = entropia_edge_add_admin_row(
			array(
				'name'   => 'row_text_1',
		...
		$group_text_res2 = entropia_edge_add_admin_group(
			array(
				'name'        => 'group_text_res2',
				'title'       => esc_html__( 'Paragraph Responsive (Mobile Devices)', 'entropia' ),
				'description' => esc_html__( 'Define responsive styles for paragraph text for mobile devices', 'entropia' ),
				'parent'      => $panel_text
			)
		);
		
		$row_res_text_2 = entropia_edge_add_admin_row(
			array(
				'name'   => 'row_res_text_2',
		...
		$group_link = entropia_edge_add_admin_group(
			array(
				'name'        => 'group_link',
				'title'       => esc_html__( 'Links', 'entropia' ),
				'description' => esc_html__( 'Define styles for link text', 'entropia' ),
				'parent'      => $panel_text
			)
		);
		
		$row_link_1 = entropia_edge_add_admin_row(
			array(
				'name'   => 'row_link_1',
				'parent' => $group_link
			)
		...
		entropia_edge_add_admin_field(
			array(
				...
				'name'          => 'link_color',
				'default_value' => '',
				'label'         => esc_html__( 'Link Color', 'entropia' ),
				'parent'        => $row_link_1
			)
		);
		...
		entropia_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hover Link Color', 'entropia' ),
				'parent'        => $row_link_1
			)
		);
		
		$row_link_2 = entropia_edge_add_admin_row(
			array(
				'name'   => 'row_link_2',
				'parent' => $group_link,
				'next'   => true
		...
		entropia_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Link Decoration', 'entropia' ),
				'options'       => entropia_edge_get_text_decorations(),
				'parent'        => $row_link_2
			)
		);
		...
		entropia_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hovel Link Decoration', 'entropia' ),
				'options'       => entropia_edge_get_text_decorations(),
				'parent'        => $row_link_2
			)
		);
	...
	add_action( 'entropia_edge_action_options_map', 'entropia_edge_fonts_options_map', entropia_edge_set_options_map_position( 'fonts' ) );
}