...
/*
   Class: EntropiaEdgeClassDashboardForm
   A class that initializes Edge Dashboard Container
*/
class EntropiaEdgeClassDashboardForm implements iEntropiaEdgeInterfaceLayoutNode, iEntropiaEdgeInterfaceRender {
	public $children;
	public $name;
	public $form_id;
	public $form_method;
...
/*
   Class: EntropiaEdgeClassDashboardGroup
   A class that initializes EntropiaEdgeClass Group Field
*/
class EntropiaEdgeClassDashboardGroup implements iEntropiaEdgeInterfaceLayoutNode, iEntropiaEdgeInterfaceRender{
	public $children;
	public $name;
	public $title;
	public $description;
...
/*
   Class: EntropiaEdgeClassDashboardTitle
   A class that initializes Dashboard Title
*/
class EntropiaEdgeClassDashboardTitle implements iEntropiaEdgeInterfaceRender {
	private $name;
	private $title;
...
/*
   Class: EntropiaEdgeClassDashboardField
   A class that initializes EntropiaEdgeClass Front Field
*/

class EntropiaEdgeClassDashboardField implements iEntropiaEdgeInterfaceRender {
	private $type;
	private $name;
	private $label;
	private $description;
...
abstract class EntropiaEdgeClassDashboardFieldType {
	abstract public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = "" );
}

class EntropiaEdgeClassDashboardFieldText extends EntropiaEdgeClassDashboardFieldType {
...
class EntropiaEdgeClassDashboardFieldTextArea extends EntropiaEdgeClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
...
class EntropiaEdgeClassDashboardFieldImage extends EntropiaEdgeClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
        $class = '';
		...
		<div class="edgtf-dashboard-field-holder <?php echo esc_attr($class); ?>">
			...
			<div class="edgtf-dashboard-gallery-holder">
				...
				<div class="edgtf-dashboard-gallery-uploader">
					<?php 
					if ( entropia_membership_theme_installed() ) {
						echo entropia_edge_get_button_html( array(
							'text'      => esc_html__( 'Upload', 'entropia' ),
							'custom_class' => 'edgtf-dashboard-gallery-upload'
						) );
					} else {
						echo '<a itemprop="url" href="#" class="edgtf-btn edgtf-btn-medium edgtf-btn-solid edgtf-dashboard-gallery-upload"><span class="edgtf-btn-text">' . esc_html__( 'Upload', 'entropia' ) . '</span></a>';
					} ?>
					...
					<?php if ($value !== '' && $value !== false) { ?>
						<button class="edgtf-btn edgtf-btn-solid edgtf-dashboard-remove-image"><?php esc_html_e('Remove Media','entropia'); ?></button>
					<?php } ?>
				</div>
			</div>
		</div>
...
class EntropiaEdgeClassDashboardFieldGallery extends EntropiaEdgeClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
        $class = '';
...
class EntropiaEdgeClassDashboardFieldSelect extends EntropiaEdgeClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
        $class = '';
...
class EntropiaEdgeClassDashboardFieldDate extends EntropiaEdgeClassFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
        if (!empty($repeat) && array_key_exists('name', $repeat) && array_key_exists('index', $repeat)) {
			$id		= $name . '-' . $repeat['index'];
			$name	= $repeat['name'] . '['.$repeat['index'].']['. $name .']';
...
class EntropiaEdgeClassDashboardFieldIcon extends EntropiaEdgeClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$options           = entropia_edge_icon_collections()->getIconCollectionsEmpty();
		$icons_collections = entropia_edge_icon_collections()->getIconCollectionsKeys();
				...
				<div class="edgtf-dashboard-item">
					...
					<div class="edgtf-dashboard-icon-holder">
						...
						<?php foreach ( $icons_collections as $icons_collection ) {
							$icons_param = entropia_edge_icon_collections()->getIconCollectionParamNameByKey( $icons_collection );
	                        $style       = 'display: none';
							...
							<div class="edgtf-icon-collection-holder" style="<?php echo esc_attr( $style ); ?>" data-icon-collection="<?php echo esc_attr( $icons_collection ); ?>">
                                <select name="<?php echo esc_attr( $name . '[' . $icons_param . ']'); ?>" id="<?php echo esc_attr( $name . '[' . $icons_param . ']'); ?>">
									<?php
									$icons = entropia_edge_icon_collections()->getIconCollection( $icons_collection );
...
class EntropiaEdgeClassDashboardFieldColor extends EntropiaEdgeClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
        if (!empty($repeat) && array_key_exists('name', $repeat) && array_key_exists('index', $repeat)) {
			$id		= $name . '-' . $repeat['index'];
			$name	= $repeat['name'] . '['.$repeat['index'].']['. $name .']';
...
class EntropiaEdgeClassDashboardFieldCheckBoxGroup extends EntropiaEdgeClassDashboardFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
...
class EntropiaEdgeClassDashboardFieldAddress extends EntropiaEdgeClassFieldType {
	public function render( $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array() ) {
		$col_width = 12;
		if ( isset( $args["col_width"] ) ) {
			$col_width = $args["col_width"];
			...
			<div class="edgtf-dashboard-field-row">
				<div class="edgtf-dashboard-item col-lg-<?php echo esc_attr($col_width); ?>">
					<div class="edgtf-dashboard-input-holder">
						...
						<a id="reset" href="#" style="display:none;"><?php esc_html_e( 'Reset Marker', 'entropia' ); ?></a>
					</div>
				</div>
			</div>
		</div>
...
class EntropiaEdgeClassDashboardRepeater implements iEntropiaEdgeInterfaceRender {
	private $label;
	private $description;
	private $name;
	private $fields;
	...
	function __construct( $fields, $name, $label = '', $description = '', $button_text = '', $table_layout = false, $value = array() ) {
		...
		$this->name        = $name;
		$this->num_of_rows = 1;
		$this->button_text = ! empty( $button_text ) ? $button_text : esc_html__( 'Add New Item', 'entropia' );
			...
			<?php if ($this->table_layout) { ?>
				<div class="edgtf-dashboard-repeater-table-heading">
					<div class="edgtf-dashboard-repeater-fields-holder">
						<div class="edgtf-dashboard-repeater-table-cell edgtf-dashboard-repeater-sort"><?php esc_html_e( 'Order', 'entropia' ) ?></div>
						...
						<div class="edgtf-dashboard-repeater-table-cell edgtf-dashboard-repeater-remove"><?php esc_html_e( 'Remove', 'entropia' ) ?></div>
					</div>
				</div>
			<?php } ?>
...
class EntropiaEdgeClassDashboardFieldFactory {
	public function render( $field_type, $name, $label = "", $description = "", $options = array(), $args = array(), $value = '', $repeat = array()) {
		switch ( strtolower( $field_type ) ) {
			case 'text':
				$field = new EntropiaEdgeClassDashboardFieldText();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'textarea':
				$field = new EntropiaEdgeClassDashboardFieldTextArea();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'date':
				$field = new EntropiaEdgeClassDashboardFieldDate();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'image':
				$field = new EntropiaEdgeClassDashboardFieldImage();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'gallery':
				$field = new EntropiaEdgeClassDashboardFieldGallery();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'select':
				$field = new EntropiaEdgeClassDashboardFieldSelect();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'icon':
				$field = new EntropiaEdgeClassDashboardFieldIcon();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;
			
			case 'color':
				$field = new EntropiaEdgeClassDashboardFieldColor();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'checkboxgroup':
				$field = new EntropiaEdgeClassDashboardFieldCheckBoxGroup();
				$field->render( $name, $label, $description, $options, $args, $value, $repeat );
				break;

			case 'address':
				$field = new EntropiaEdgeClassDashboardFieldAddress();
