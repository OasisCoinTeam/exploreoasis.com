...
if ( ! function_exists( 'entropia_edge_add_dripicons_icon_pack' ) ) {
	function entropia_edge_add_dripicons_icon_pack( $iconCollections ) {
		$iconCollections['dripicons'] = new EntropiaEdgeClassDripicons( 'Dripicons', 'dripicon' );
		
		return $iconCollections;
	}
	
	add_filter( 'entropia_edge_filter_add_icon_pack_into_collection', 'entropia_edge_add_dripicons_icon_pack' );
}

if ( ! function_exists( 'entropia_edge_add_dripicons_icon_pack_option' ) ) {
	function entropia_edge_add_dripicons_icon_pack_option( $options ) {
		$options['dripicons'] = esc_html__( 'Dripicons', 'entropia' );
		
		return $options;
	}
	
	add_filter( 'entropia_edge_filter_add_icon_pack_into_options', 'entropia_edge_add_dripicons_icon_pack_option' );
}

class EntropiaEdgeClassDripicons implements iEntropiaEdgeInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
