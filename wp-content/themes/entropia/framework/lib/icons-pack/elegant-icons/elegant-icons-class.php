...
if ( ! function_exists( 'entropia_edge_add_font_elegant_icon_pack' ) ) {
	function entropia_edge_add_font_elegant_icon_pack( $iconCollections ) {
		$iconCollections['font_elegant'] = new EntropiaEdgeClassIconsFontElegant( 'Font Elegant', 'fe_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'entropia_edge_filter_add_icon_pack_into_collection', 'entropia_edge_add_font_elegant_icon_pack' );
}

if ( ! function_exists( 'entropia_edge_add_font_elegant_icon_pack_option' ) ) {
	function entropia_edge_add_font_elegant_icon_pack_option( $options ) {
		$options['font_elegant'] = esc_html__( 'Font Elegant', 'entropia' );
		
		return $options;
	}
	
	add_filter( 'entropia_edge_filter_add_icon_pack_into_options', 'entropia_edge_add_font_elegant_icon_pack_option' );
	add_filter( 'entropia_edge_filter_add_icon_pack_into_social_options', 'entropia_edge_add_font_elegant_icon_pack_option' );
}

class EntropiaEdgeClassIconsFontElegant implements iEntropiaEdgeInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
