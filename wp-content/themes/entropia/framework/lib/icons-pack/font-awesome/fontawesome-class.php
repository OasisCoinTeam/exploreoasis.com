...
if ( ! function_exists( 'entropia_edge_add_font_awesome_icon_pack' ) ) {
	function entropia_edge_add_font_awesome_icon_pack( $iconCollections ) {
		$iconCollections['font_awesome'] = new EntropiaEdgeClassIconsFontAwesome( 'Font Awesome', 'fa_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'entropia_edge_filter_add_icon_pack_into_collection', 'entropia_edge_add_font_awesome_icon_pack' );
}

if ( ! function_exists( 'entropia_edge_add_font_awesome_icon_pack_option' ) ) {
	function entropia_edge_add_font_awesome_icon_pack_option( $options ) {
		$options['font_awesome'] = esc_html__( 'Font Awesome', 'entropia' );
		
		return $options;
	}
	
	add_filter( 'entropia_edge_filter_add_icon_pack_into_options', 'entropia_edge_add_font_awesome_icon_pack_option' );
	add_filter( 'entropia_edge_filter_add_icon_pack_into_social_options', 'entropia_edge_add_font_awesome_icon_pack_option' );
}

class EntropiaEdgeClassIconsFontAwesome implements iEntropiaEdgeInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
