...
if ( ! function_exists( 'entropia_edge_add_ion_icon_pack' ) ) {
	function entropia_edge_add_ion_icon_pack( $iconCollections ) {
		$iconCollections['ion_icons'] = new EntropiaEdgeClassIonIcons( 'Ion Icons', 'ion_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'entropia_edge_filter_add_icon_pack_into_collection', 'entropia_edge_add_ion_icon_pack' );
}

if ( ! function_exists( 'entropia_edge_add_ion_icon_pack_option' ) ) {
	function entropia_edge_add_ion_icon_pack_option( $options ) {
		$options['ion_icons'] = esc_html__( 'Ion Icons', 'entropia' );
		
		return $options;
	}
	
	add_filter( 'entropia_edge_filter_add_icon_pack_into_options', 'entropia_edge_add_ion_icon_pack_option' );
	add_filter( 'entropia_edge_filter_add_icon_pack_into_social_options', 'entropia_edge_add_ion_icon_pack_option' );
}

class EntropiaEdgeClassIonIcons implements iEntropiaEdgeInterfaceIconCollection {
	public $icons;
	public $socialIcons;
    public $title;
	public $param;
