...
if ( ! function_exists( 'entropia_edge_add_linea_icon_pack' ) ) {
	function entropia_edge_add_linea_icon_pack( $iconCollections ) {
		$iconCollections['linea_icons'] = new EntropiaEdgeClassLineaIcons( 'Linea Icons', 'linea_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'entropia_edge_filter_add_icon_pack_into_collection', 'entropia_edge_add_linea_icon_pack' );
}

if ( ! function_exists( 'entropia_edge_add_linea_icon_pack_option' ) ) {
	function entropia_edge_add_linea_icon_pack_option( $options ) {
		$options['linea_icons'] = esc_html__( 'Linea Icons', 'entropia' );
		
		return $options;
	}
	
	add_filter( 'entropia_edge_filter_add_icon_pack_into_options', 'entropia_edge_add_linea_icon_pack_option' );
}

class EntropiaEdgeClassLineaIcons implements iEntropiaEdgeInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
