...
if ( ! function_exists( 'entropia_edge_add_linear_icon_pack' ) ) {
	function entropia_edge_add_linear_icon_pack( $iconCollections ) {
		$iconCollections['linear_icons'] = new EntropiaEdgeClassLinearIcons( 'Linear Icons', 'linear_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'entropia_edge_filter_add_icon_pack_into_collection', 'entropia_edge_add_linear_icon_pack' );
}

if ( ! function_exists( 'entropia_edge_add_linear_icon_pack_option' ) ) {
	function entropia_edge_add_linear_icon_pack_option( $options ) {
		$options['linear_icons'] = esc_html__( 'Linear Icons', 'entropia' );
		
		return $options;
	}
	
	add_filter( 'entropia_edge_filter_add_icon_pack_into_options', 'entropia_edge_add_linear_icon_pack_option' );
}

class EntropiaEdgeClassLinearIcons implements iEntropiaEdgeInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
