...
if ( ! function_exists( 'entropia_edge_add_simple_line_icon_pack' ) ) {
	function entropia_edge_add_simple_line_icon_pack( $iconCollections ) {
		$iconCollections['simple_line_icons'] = new EntropiaEdgeClassSimpleLineIcons( 'Simple Line Icons', 'simple_line_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'entropia_edge_filter_add_icon_pack_into_collection', 'entropia_edge_add_simple_line_icon_pack' );
}

if ( ! function_exists( 'entropia_edge_add_simple_line_icon_pack_option' ) ) {
	function entropia_edge_add_simple_line_icon_pack_option( $options ) {
		$options['simple_line_icons'] = esc_html__( 'Simple Line Icons', 'entropia' );
		
		return $options;
	}
	
	add_filter( 'entropia_edge_filter_add_icon_pack_into_options', 'entropia_edge_add_simple_line_icon_pack_option' );
	add_filter( 'entropia_edge_filter_add_icon_pack_into_social_options', 'entropia_edge_add_simple_line_icon_pack_option' );
}

class EntropiaEdgeClassSimpleLineIcons implements iEntropiaEdgeInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'entropia'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'entropia'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'entropia'),
            'icon-social-facebook'    => esc_html__('Facebook', 'entropia'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'entropia'),
            'icon-social-github'      => esc_html__('Github', 'entropia'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'entropia'),
            'icon-social-instagram'   => esc_html__('Instagram', 'entropia'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'entropia'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'entropia'),
            'icon-social-reddit'      => esc_html__('Reddit', 'entropia'),
            'icon-social-skype'       => esc_html__('Skype', 'entropia'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'entropia'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'entropia'),
            'icon-social-spotify'     => esc_html__('Spotify', 'entropia'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'entropia'),
            'icon-social-twitter'     => esc_html__('Twitter', 'entropia'),
            'icon-social-youtube'     => esc_html__('Youtube', 'entropia')
        );
    }
