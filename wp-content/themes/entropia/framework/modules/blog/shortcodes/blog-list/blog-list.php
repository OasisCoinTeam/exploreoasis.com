<?php
namespace EntropiaCore\CPT\Shortcodes\BlogList;
...
class BlogList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(
			array(
				'name'                      => esc_html__( 'Blog List', 'entropia' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					array(
						...
						'value'       => array(
							...
							esc_html__( 'Boxed', 'entropia' )    => 'boxed',
							esc_html__( 'Masonry', 'entropia' )  => 'masonry',
							esc_html__( 'Simple', 'entropia' )   => 'simple',
							esc_html__( 'Minimal', 'entropia' )  => 'minimal'
						),
						'save_always' => true
					),
					array(
						...
						'heading'    => esc_html__( 'Number of Posts', 'entropia' )
					),
					array(
						'type'       => 'dropdown',
					...
					array(
						'type'        => 'autocomplete',
						'param_name'  => 'category',
						'heading'     => esc_html__( 'Category', 'entropia' ),
						'description' => esc_html__( 'Enter one category slug (leave empty for showing all categories)', 'entropia' )
					),
					array(
						'type'       => 'dropdown',
						'param_name' => 'image_size',
						'heading'    => esc_html__( 'Image Size', 'entropia' ),
						'value'      => array(
							...
							esc_html__( 'Thumbnail', 'entropia' ) => 'thumbnail',
					...
					array(
						...
						'group'      => esc_html__( 'Post Info', 'entropia' )
					),
					array(
						'type'       => 'dropdown',
                    ...
                    array(
                        ...
                        'heading'    => esc_html__( 'Enable Post Info Excerpt', 'entropia' ),
					...
					array(
						...
						'heading'     => esc_html__( 'Text Length', 'entropia' ),
						'description' => esc_html__( 'Number of words', 'entropia' ),
						'dependency'  => Array( 'element' => 'type', 'value'   => array( 'standard', 'boxed', 'masonry', 'simple' ), 'element' => 'post_info_excerpt', 'value' => array( 'yes' ) ),
						'group'       => esc_html__( 'Post Info', 'entropia' )
					),
					array(
						'type'       => 'dropdown',
						'param_name' => 'post_info_image',
						'heading'    => esc_html__( 'Enable Post Info Image', 'entropia' ),
						'value'      => array_flip( entropia_edge_get_yes_no_select_array( false, false ) ),
						'dependency' => Array( 'element' => 'type', 'value'   => array( 'standard', 'boxed', 'masonry' ) ),
						'group'      => esc_html__( 'Post Info', 'entropia' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Section', 'entropia' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Author', 'entropia' ),
						'value'      => array_flip( entropia_edge_get_yes_no_select_array( false, true ) ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Date', 'entropia' ),
						'value'      => array_flip( entropia_edge_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'entropia' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Category', 'entropia' ),
						'value'      => array_flip( entropia_edge_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'entropia' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Comments', 'entropia' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Like', 'entropia' ),
						'value'      => array_flip( entropia_edge_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'entropia' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Share', 'entropia' ),
						'value'      => array_flip( entropia_edge_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'entropia' )
					),
					array(
						...
						'heading'    => esc_html__( 'Pagination Type', 'entropia' ),
						'value'      => array(
							esc_html__( 'None', 'entropia' )            => 'no-pagination',
							esc_html__( 'Standard', 'entropia' )        => 'standard-shortcodes',
							esc_html__( 'Load More', 'entropia' )       => 'load-more',
							esc_html__( 'Infinite Scroll', 'entropia' ) => 'infinite-scroll'
						),
						'group'      => esc_html__( 'Additional Features', 'entropia' )
					)
				)
			)
		);
	...
	public function render( $atts, $content = null ) {
		...
		entropia_edge_get_module_template_part( 'shortcodes/blog-list/holder', 'blog', $params['type'], $params );
	...
	public function blogCategoryAutocompleteSuggester( $query ) {
		...
		if ( is_array( $post_meta_infos ) && ! empty( $post_meta_infos ) ) {
			foreach ( $post_meta_infos as $value ) {
				...
				$data['label'] = ( ( strlen( $value['category_title'] ) > 0 ) ? esc_html__( 'Category', 'entropia' ) . ': ' . $value['category_title'] : '' );
				$results[]     = $data;
			}
		}
		...
		if ( ! empty( $query ) ) {
			...
			if ( is_object( $category ) ) {
				...
				if ( ! empty( $category_title ) ) {
					$category_title_display = esc_html__( 'Category', 'entropia' ) . ': ' . $category_title;
				}
