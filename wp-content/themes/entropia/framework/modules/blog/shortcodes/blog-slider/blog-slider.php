<?php
namespace EntropiaCore\CPT\Shortcodes\BlogSlider;
...
class BlogSlider implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(
			array(
				'name'                      => esc_html__( 'Blog Slider', 'entropia' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					array(
						...
						'value'       => array(
							esc_html__( 'Slider', 'entropia' )            => 'slider',
							esc_html__( 'Carousel', 'entropia' )          => 'carousel',
							esc_html__( 'Carousel Centered', 'entropia' ) => 'carousel-centered'
						),
						'save_always' => true
					),
					array(
	...
	public function render( $atts, $content = null ) {
		...
		entropia_edge_get_module_template_part( 'shortcodes/blog-slider/holder', 'blog', '', $params );
