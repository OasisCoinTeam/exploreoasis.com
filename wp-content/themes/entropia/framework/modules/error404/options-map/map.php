...
if ( ! function_exists( 'entropia_edge_error_404_options_map' ) ) {
	function entropia_edge_error_404_options_map() {
		
		entropia_edge_add_admin_page(
			array(
				'slug'  => '__404_error_page',
				'title' => esc_html__( '404 Error Page', 'entropia' ),
				'icon'  => 'fa fa-exclamation-triangle'
			)
		);
		
		$panel_404_header = entropia_edge_add_admin_panel(
			array(
		...
		entropia_edge_add_admin_field(
			array(
				...
				'description' => esc_html__( 'Choose a border bottom color for header area', 'entropia' )
			)
		);
		...
		$panel_404_options = entropia_edge_add_admin_panel(
			array(
				'page'  => '__404_error_page',
				'name'  => 'panel_404_options',
				'title' => esc_html__( '404 Page Options', 'entropia' )
			)
		);
		...
		entropia_edge_add_admin_field(
			array(
				...
				'description' => esc_html__( 'Choose a background image for 404 page', 'entropia' )
			)
		);
		...
		entropia_edge_add_admin_field(
			array(
				...
				'description' => esc_html__( 'Choose a pattern image for 404 page', 'entropia' )
			)
		);
		...
		entropia_edge_add_admin_field(
			array(
				...
				'label'       => esc_html__( 'Title Image', 'entropia' ),
				'description' => esc_html__( 'Choose a background image for displaying above 404 page Title', 'entropia' )
			)
		);
		...
		entropia_edge_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Enter title for 404 page. Default label is "404".', 'entropia' )
			)
		);
		...
		$first_level_group = entropia_edge_add_admin_group(
			array(
				...
				'title'       => esc_html__( 'Title Style', 'entropia' ),
				'description' => esc_html__( 'Define styles for 404 page title', 'entropia' )
			)
		);
		...
		$first_level_row2 = entropia_edge_add_admin_row(
			array(
				'parent' => $first_level_group,
        ...
        $first_level_group_responsive = entropia_edge_add_admin_group(
            array(
                'parent'      => $panel_404_options,
                'name'        => 'first_level_group_responsive',
                'title'       => esc_html__( 'Title Style Responsive', 'entropia' ),
                'description' => esc_html__( 'Define responsive styles for 404 page title (under 680px)', 'entropia' )
            )
        );
		...
		entropia_edge_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Enter subtitle for 404 page. Default label is "PAGE NOT FOUND".', 'entropia' )
			)
		);
		...
		$second_level_group = entropia_edge_add_admin_group(
			array(
				...
				'title'       => esc_html__( 'Subtitle Style', 'entropia' ),
				'description' => esc_html__( 'Define styles for 404 page subtitle', 'entropia' )
			)
		);
        ...
        $second_level_group_responsive = entropia_edge_add_admin_group(
            array(
                'parent'      => $panel_404_options,
                'name'        => 'second_level_group_responsive',
                'title'       => esc_html__( 'Subtitle Style Responsive', 'entropia' ),
                'description' => esc_html__( 'Define responsive styles for 404 page subtitle (under 680px)', 'entropia' )
            )
        );
		...
		entropia_edge_add_admin_field(
			array(
				...
				'name'          => '404_text',
				'default_value' => '',
				'label'         => esc_html__( 'Text', 'entropia' ),
				'description'   => esc_html__( 'Enter text for 404 page.', 'entropia' )
			)
		);
		...
		$third_level_group = entropia_edge_add_admin_group(
			array(
				...
				'title'       => esc_html__( 'Text Style', 'entropia' ),
				'description' => esc_html__( 'Define styles for 404 page text', 'entropia' )
			)
		);
        ...
        $third_level_group_responsive = entropia_edge_add_admin_group(
            array(
                'parent'      => $panel_404_options,
                'name'        => 'third_level_group_responsive',
                'title'       => esc_html__( 'Text Style Responsive', 'entropia' ),
                'description' => esc_html__( 'Define responsive styles for 404 page text (under 680px)', 'entropia' )
            )
        );
		...
		entropia_edge_add_admin_field(
			array(
				...
				'label'       => esc_html__( 'Back to Home Button Label', 'entropia' ),
				'description' => esc_html__( 'Enter label for "Back to home" button', 'entropia' )
			)
		);
		...
		entropia_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Skin', 'entropia' ),
				'description'   => esc_html__( 'Choose a style to make Back to Home button in that predefined style', 'entropia' ),
				'options'       => array(
					''            => esc_html__( 'Default', 'entropia' ),
					'light-style' => esc_html__( 'Light', 'entropia' )
				)
			)
		);
	}
	
	add_action( 'entropia_edge_action_options_map', 'entropia_edge_error_404_options_map', entropia_edge_set_options_map_position( '404' ) );
}