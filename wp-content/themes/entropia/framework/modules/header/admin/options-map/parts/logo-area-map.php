...
if ( ! function_exists( 'entropia_edge_get_hide_dep_for_header_logo_area_options' ) ) {
	function entropia_edge_get_hide_dep_for_header_logo_area_options() {
		$hide_dep_options = apply_filters( 'entropia_edge_filter_header_logo_area_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'entropia_edge_header_logo_area_options_map' ) ) {
	function entropia_edge_header_logo_area_options_map( $panel_header ) {
		$hide_dep_options = entropia_edge_get_hide_dep_for_header_logo_area_options();
		...
		entropia_edge_add_admin_section_title(
			array(
				...
				'title'  => esc_html__( 'Logo Area', 'entropia' )
			)
		);
		...
		entropia_edge_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Set grid background transparency', 'entropia' ),
				'args'          => array(
					'col_width' => 3
				)
			)
		...
		entropia_edge_add_admin_field(
			array(
				...
				'description' => esc_html__( 'Set background color for logo area', 'entropia' )
			)
		);
		...
		entropia_edge_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Set background transparency for logo area', 'entropia' ),
				'args'          => array(
					'col_width' => 3
				)
			)
		...
		$logo_area_border_container = entropia_edge_add_admin_container(
			array(
				'parent'          => $logo_area_container,
		...
		entropia_edge_add_admin_field(
			array(
				...
				'label'         => esc_html__( 'Border Color', 'entropia' ),
				'description'   => esc_html__( 'Set border color for logo area', 'entropia' ),
		...
		do_action( 'entropia_edge_header_logo_area_additional_options', $logo_area_container );
	}
	
	add_action( 'entropia_edge_action_header_logo_area_options_map', 'entropia_edge_header_logo_area_options_map', 10, 1 );
}