<div class="edgtf-subscribe-popup-holder <?php echo esc_attr( $holder_classes ); ?>">
        ...
        <div class="edgtf-sp-table-cell">
            <div class="edgtf-sp-inner">
	            ...
	            <?php if ( ! empty( $background_styles ) ) { ?>
		            <div class="edgtf-sp-background" <?php entropia_edge_inline_style( $background_styles ); ?>></div>
	            <?php } ?>
                <div class="edgtf-sp-content-container">
	                <?php if ( ! empty( $title ) ) { ?>
		                <h3 class="edgtf-sp-title"><?php echo esc_html( $title ); ?></h3>
	                <?php } ?>
	                ...
	                <?php if ( $enable_prevent === 'yes' ) { ?>
		                <div class="edgtf-sp-prevent">
			                <div class="edgtf-sp-prevent-inner">
				                ...
				                <label class="edgtf-sp-prevent-label"><?php esc_html_e( 'Prevent This Pop-up', 'entropia' ); ?></label>
			                </div>
		                </div>
	                <?php } ?>
                </div>
