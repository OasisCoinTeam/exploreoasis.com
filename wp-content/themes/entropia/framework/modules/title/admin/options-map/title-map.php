...
if ( ! function_exists( 'entropia_edge_get_title_types_options' ) ) {
	function entropia_edge_get_title_types_options() {
		$title_type_options = apply_filters( 'entropia_edge_filter_title_type_global_option', $title_type_options = array() );
		
		return $title_type_options;
	}
}

if ( ! function_exists( 'entropia_edge_get_title_type_default_options' ) ) {
	function entropia_edge_get_title_type_default_options() {
		$title_type_option = apply_filters( 'entropia_edge_filter_default_title_type_global_option', $title_type_option = '' );
...
if ( ! function_exists('entropia_edge_title_options_map') ) {
	function entropia_edge_title_options_map() {
		$title_type_options        = entropia_edge_get_title_types_options();
		$title_type_default_option = entropia_edge_get_title_type_default_options();
		...
		$panel_title = entropia_edge_add_admin_panel(
			array(
				'page' => '_title_page',
				'name' => 'panel_title',
				'title' => esc_html__('Title Settings', 'entropia')
			)
		);
		...
		entropia_edge_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'This option will enable/disable Title Area', 'entropia' ),
				'parent'        => $panel_title
			)
		);
		
			$show_title_area_container = entropia_edge_add_admin_container(
				array(
					'parent'          => $panel_title,
				...
				entropia_edge_add_admin_field(
					...
					entropia_edge_add_admin_field(
						array(
							...
							'description'   => esc_html__( 'Specify title vertical alignment', 'entropia' ),
							'parent'        => $show_title_area_container,
							'options'       => array(
		...
		do_action( 'entropia_edge_action_additional_title_area_options_map', $show_title_area_container );
		
		/***************** Additional Title Area Layout - end *****************/
		
		
		$panel_typography = entropia_edge_add_admin_panel(
			array(
				'page'  => '_title_page',
			...
			$group_page_title_styles = entropia_edge_add_admin_group(
				array(
					'name'        => 'group_page_title_styles',
					'title'       => esc_html__( 'Title', 'entropia' ),
					'description' => esc_html__( 'Define styles for page title', 'entropia' ),
					'parent'      => $panel_typography
				)
			);
		
				$row_page_title_styles_1 = entropia_edge_add_admin_row(
					array(
					...
					entropia_edge_add_admin_field(
						array(
							...
							'options'       => entropia_edge_get_title_tag(false, array('custom-size' => esc_html__( 'Custom Size', 'entropia' ))),
							'parent'        => $row_page_title_styles_1
						)
					);
		
				$row_page_title_styles_2 = entropia_edge_add_admin_row(
					array(
				...
				$row_page_title_styles_3 = entropia_edge_add_admin_row(
					array(
			...
			entropia_edge_add_admin_section_title(
				array(
					...
					'title'  => esc_html__( 'Subtitle', 'entropia' ),
					'parent' => $panel_typography
				)
			);
		
			$group_page_subtitle_styles = entropia_edge_add_admin_group(
				array(
					'name'        => 'group_page_subtitle_styles',
					'title'       => esc_html__( 'Subtitle', 'entropia' ),
					'description' => esc_html__( 'Define styles for page subtitle', 'entropia' ),
					'parent'      => $panel_typography
				)
			);
		
				$row_page_subtitle_styles_1 = entropia_edge_add_admin_row(
					array(
				...
				$row_page_subtitle_styles_2 = entropia_edge_add_admin_row(
					array(
				...
				$row_page_subtitle_styles_3 = entropia_edge_add_admin_row(
					array(
		...
		do_action( 'entropia_edge_action_additional_title_typography_options_map', $panel_typography );
		
		/***************** Additional Title Typography Layout - end *****************/
    }

	add_action( 'entropia_edge_action_options_map', 'entropia_edge_title_options_map', entropia_edge_set_options_map_position( 'title' ) );
}