...
namespace EntropiaCore\CPT\Shortcodes\ProductListCarousel;
...
class ProductListCarousel implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Product List - Carousel', 'entropia' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Number Of Visible Items', 'entropia' ),
							'value'       => array(
								esc_html__( 'One', 'entropia' )   => '1',
								esc_html__( 'Two', 'entropia' )   => '2',
								esc_html__( 'Three', 'entropia' ) => '3',
								esc_html__( 'Four', 'entropia' )  => '4',
								esc_html__( 'Five', 'entropia' )  => '5',
								esc_html__( 'Six', 'entropia' )   => '6'
							),
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'entropia' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'slider_loop',
							'heading'     => esc_html__( 'Enable Slider Loop', 'entropia' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Autoplay', 'entropia' ),
							'value'       => array_flip( entropia_edge_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'entropia' )
						),
						array(
							...
							'heading'     => esc_html__( 'Slide Duration', 'entropia' ),
							'description' => esc_html__( 'Default value is 5000 (ms)', 'entropia' ),
							'group'       => esc_html__( 'Slider Settings', 'entropia' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'slider_speed_animation',
							'heading'     => esc_html__( 'Slide Animation Duration', 'entropia' ),
							'description' => esc_html__( 'Speed of slide animation in milliseconds. Default value is 600.', 'entropia' ),
							'group'       => esc_html__( 'Slider Settings', 'entropia' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'slider_navigation',
							'heading'     => esc_html__( 'Enable Slider Navigation Arrows', 'entropia' ),
							'value'       => array_flip( entropia_edge_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'entropia' )
						),
						array(
							...
							'heading'    => esc_html__( 'Slider Navigation Skin', 'entropia' ),
							'value'      => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Pagination', 'entropia' ),
							'value'       => array_flip( entropia_edge_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'entropia' )
						),
						array(
							...
							'heading'    => esc_html__( 'Slider Pagination Skin', 'entropia' ),
							'value'      => array(
								esc_html__( 'Default', 'entropia' ) => 'default',
								esc_html__( 'Light', 'entropia' )   => 'light'
							),
						...
						array(
							...
							'heading'    => esc_html__( 'Slider Pagination Position', 'entropia' ),
							'value'      => array(
								esc_html__( 'Below Carousel', 'entropia' )  => 'bellow-slider',
								esc_html__( 'Inside Carousel', 'entropia' ) => 'inside-slider'
							),
							'dependency' => array( 'element' => 'slider_pagination', 'value' => array( 'yes' ) ),
							'group'      => esc_html__( 'Slider Settings', 'entropia' )
						),
	...
	public function render( $atts, $content = null ) {
		...
		$html = entropia_edge_get_woo_shortcode_module_template_part( 'templates/product-list', 'product-list-carousel', $params['type'], $params, $additional_params );
