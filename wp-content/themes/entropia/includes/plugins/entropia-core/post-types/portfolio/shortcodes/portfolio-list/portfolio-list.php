...
namespace EntropiaCore\CPT\Shortcodes\Portfolio;
...
class PortfolioList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map( array(
					'name'     => esc_html__( 'Portfolio List', 'entropia-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						array(
							'type'        => 'dropdown',
							'param_name'  => 'type',
							'heading'     => esc_html__( 'Portfolio List Template', 'entropia-core' ),
							'value'       => array(
								esc_html__( 'Gallery', 'entropia-core' ) => 'gallery',
								esc_html__( 'Masonry', 'entropia-core' ) => 'masonry'
							),
							'save_always' => true,
							'admin_label' => true
						),
						array(
							...
							'heading'    => esc_html__( 'Click Behavior', 'entropia-core' ),
							'value'      => array(
								esc_html__( 'Open portfolio single page on click', 'entropia-core' )   => '',
								esc_html__( 'Open gallery in Pretty Photo on click', 'entropia-core' ) => 'gallery'
							)
						),
						array(
							'type'        => 'dropdown',
							...
							'description' => esc_html__( 'Default value is Three', 'entropia-core' ),
							'save_always' => true
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'heading'     => esc_html__( 'Number of Portfolios Per Page', 'entropia-core' ),
							'description' => esc_html__( 'Set number of items for your portfolio list. Enter -1 to show all.', 'entropia-core' ),
							'value'       => '-1'
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'image_proportions',
							'heading'     => esc_html__( 'Image Proportions', 'entropia-core' ),
							'value'       => array(
								esc_html__( 'Original', 'entropia-core' )  => 'full',
								esc_html__( 'Square', 'entropia-core' )    => 'square',
								esc_html__( 'Landscape', 'entropia-core' ) => 'landscape',
								esc_html__( 'Portrait', 'entropia-core' )  => 'portrait',
								esc_html__( 'Medium', 'entropia-core' )    => 'medium',
								esc_html__( 'Large', 'entropia-core' )     => 'large'
							),
							'description' => esc_html__( 'Set image proportions for your portfolio list.', 'entropia-core' ),
							'dependency'  => array( 'element' => 'type', 'value' => array( 'gallery' ) )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'enable_fixed_proportions',
							'heading'     => esc_html__( 'Enable Fixed Image Proportions', 'entropia-core' ),
							'value'       => array_flip( entropia_edge_get_yes_no_select_array( false ) ),
							'description' => esc_html__( 'Set predefined image proportions for your masonry portfolio list. This option will apply image proportions you set in Portfolio Single page - dimensions for masonry option.', 'entropia-core' ),
							'dependency'  => array( 'element' => 'type', 'value' => array( 'masonry' ) )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'enable_image_shadow',
							'heading'     => esc_html__( 'Enable Image Shadow', 'entropia-core' ),
							'value'       => array_flip( entropia_edge_get_yes_no_select_array( false ) ),
							'save_always' => true
						),
						array(
							'type'        => 'autocomplete',
							'param_name'  => 'category',
							'heading'     => esc_html__( 'One-Category Portfolio List', 'entropia-core' ),
						...
						array(
							'type'        => 'autocomplete',
							'param_name'  => 'tag',
							'heading'     => esc_html__( 'One-Tag Portfolio List', 'entropia-core' ),
							'description' => esc_html__( 'Enter one tag slug (leave empty for showing all tags)', 'entropia-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'orderby',
						...
						array(
							...
							'heading'    => esc_html__( 'Item Style', 'entropia-core' ),
							'value'      => array(
								esc_html__( 'Standard - Shader', 'entropia-core' )                 => 'standard-shader',
								esc_html__( 'Standard - Switch Featured Images', 'entropia-core' ) => 'standard-switch-images',
								esc_html__( 'Gallery - Overlay', 'entropia-core' )                 => 'gallery-overlay',
                                esc_html__( 'Gallery - Bordered Overlay', 'entropia-core' )                 => 'gallery-bordered-overlay',
								esc_html__( 'Gallery - Slide From Image Bottom', 'entropia-core' ) => 'gallery-slide-from-image-bottom'
							),
							'group'      => esc_html__( 'Content Layout', 'entropia-core' )
						),
                        array(
                            'type'       => 'dropdown',
                            'param_name' => 'enable_overlay_image',
                            'heading'    => esc_html__( 'Enable Overlay Image', 'entropia-core' ),
                            'description' => esc_html__( 'If overlay image is added on single item, otherwise item has default overlay', 'entropia-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Content Top Margin (px or %)', 'entropia-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Content Bottom Margin (px or %)', 'entropia-core' ),
							'dependency' => array( 'element' => 'item_style', 'value' => array( 'standard-shader', 'standard-switch-images' ) ),
							'group'      => esc_html__( 'Content Layout', 'entropia-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Enable Title', 'entropia-core' ),
							'value'      => array_flip( entropia_edge_get_yes_no_select_array( false, true ) ),
							'group'      => esc_html__( 'Content Layout', 'entropia-core' )
						),
						array(
						...
						array(
							...
							'heading'    => esc_html__( 'Title Text Transform', 'entropia-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Enable Category', 'entropia-core' ),
							'value'      => array_flip( entropia_edge_get_yes_no_select_array( false, true ) ),
							'group'      => esc_html__( 'Content Layout', 'entropia-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Enable Number of Images', 'entropia-core' ),
							'value'      => array_flip( entropia_edge_get_yes_no_select_array( false, true ) ),
							'dependency' => array( 'element' => 'type', 'value' => array( 'gallery' ) ),
							'group'      => esc_html__( 'Content Layout', 'entropia-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Enable Excerpt', 'entropia-core' ),
							'value'      => array_flip( entropia_edge_get_yes_no_select_array( false ) ),
							'group'      => esc_html__( 'Content Layout', 'entropia-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Excerpt Length', 'entropia-core' ),
							'description' => esc_html__( 'Number of characters', 'entropia-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Pagination Type', 'entropia-core' ),
							'value'      => array(
								esc_html__( 'None', 'entropia-core' )            => 'no-pagination',
								esc_html__( 'Standard', 'entropia-core' )        => 'standard',
								esc_html__( 'Load More', 'entropia-core' )       => 'load-more',
								esc_html__( 'Infinite Scroll', 'entropia-core' ) => 'infinite-scroll'
							),
							'group'      => esc_html__( 'Additional Features', 'entropia-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'load_more_top_margin',
							'heading'    => esc_html__( 'Load More Top Margin (px or %)', 'entropia-core' ),
						...
						array(
							'type'       => 'dropdown',
							'param_name' => 'filter',
							'heading'    => esc_html__( 'Enable Category Filter', 'entropia-core' ),
							'value'      => array_flip( entropia_edge_get_yes_no_select_array( false ) ),
							'group'      => esc_html__( 'Additional Features', 'entropia-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Filter Order By', 'entropia-core' ),
							'value'      => array(
								esc_html__( 'Name', 'entropia-core' )  => 'name',
								esc_html__( 'Count', 'entropia-core' ) => 'count',
								esc_html__( 'Id', 'entropia-core' )    => 'id',
								esc_html__( 'Slug', 'entropia-core' )  => 'slug'
							),
						...
						array(
							...
							'heading'    => esc_html__( 'Filter Text Transform', 'entropia-core' ),
							'value'      => array_flip( entropia_edge_get_text_transform_array( true ) ),
							'dependency' => array( 'element' => 'filter', 'value' => array( 'yes' ) ),
							'group'      => esc_html__( 'Additional Features', 'entropia-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Filter Bottom Margin (px or %)', 'entropia-core' ),
							'dependency' => array( 'element' => 'filter', 'value' => array( 'yes' ) ),
							'group'      => esc_html__( 'Additional Features', 'entropia-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Enable Article Animation', 'entropia-core' ),
							'value'       => array_flip( entropia_edge_get_yes_no_select_array( false ) ),
							'description' => esc_html__( 'Enabling this option you will enable appears animation for your portfolio list items', 'entropia-core' ),
							'group'       => esc_html__( 'Additional Features', 'entropia-core' )
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$additional_params['holder_data']          = entropia_edge_get_holder_data_for_cpt( $params, $additional_params );
		...
		$html = entropia_core_get_cpt_shortcode_module_template_part( 'portfolio', 'portfolio-list', 'portfolio-holder', $params['type'], $params, $additional_params );
	...
	public function getImageSize( $params ) {
		...
		if ( ! empty( $params['image_proportions'] ) && $params['type'] == 'gallery' ) {
			...
			switch ( $image_size ) {
				case 'landscape':
					$thumb_size = 'entropia_edge_image_landscape';
					break;
				case 'portrait':
					$thumb_size = 'entropia_edge_image_portrait';
					break;
				case 'square':
					$thumb_size = 'entropia_edge_image_square';
					break;
				case 'medium':
					$thumb_size = 'medium';
					break;
		...
		if ( $params['type'] == 'masonry' && $params['enable_fixed_proportions'] === 'yes' ) {
			...
			switch ( $fixed_image_size ) {
				...
				case 'large-width-height':
					$thumb_size = 'entropia_edge_image_huge';
					break;
				default :
					$thumb_size = 'full';
					break;
	...
	public function getStandardContentStyles( $params ) {
		...
		if ( ! empty( $margin_top ) ) {
			if ( entropia_edge_string_ends_with( $margin_top, '%' ) || entropia_edge_string_ends_with( $margin_top, 'px' ) ) {
		...
		if ( ! empty( $margin_bottom ) ) {
			if ( entropia_edge_string_ends_with( $margin_bottom, '%' ) || entropia_edge_string_ends_with( $margin_bottom, 'px' ) ) {
    ...
    public function getOverlayStyle( $params ) {
        $styles = array();

        $overlay_image_meta = get_post_meta( get_the_ID(), 'edgtf_portfolio_overlay_image_meta', true );

        if ( ! empty($overlay_image_meta && $params['enable_overlay_image'] =='yes') ) {
            $styles[] = 'background: transparent url(' . $overlay_image_meta . ')';
        }
	...
	public function getLoadMoreStyles( $params ) {
		...
		if ( ! empty( $params['load_more_top_margin'] ) ) {
			...
			if ( entropia_edge_string_ends_with( $margin, '%' ) || entropia_edge_string_ends_with( $margin, 'px' ) ) {
				$styles[] = 'margin-top: ' . $margin;
			} else {
				$styles[] = 'margin-top: ' . entropia_edge_filter_px( $margin ) . 'px';
			}
		}
	...
	public function getFilterHolderStyles( $params ) {
		...
		if ( ! empty( $params['filter_bottom_margin'] ) ) {
			...
			if ( entropia_edge_string_ends_with( $margin, '%' ) || entropia_edge_string_ends_with( $margin, 'px' ) ) {
				...
				$styles[] = 'margin-bottom: ' . entropia_edge_filter_px( $margin ) . 'px';
			}
		}
	...
	public function getItemLink() {
		...
		return apply_filters( 'entropia_edge_filter_portfolio_external_link', $portfolio_link );
	}
	...
	public function getItemLinkTarget() {
		...
		return apply_filters( 'entropia_edge_filter_portfolio_external_link_target', $portfolio_link_target );
	}
	...
	public function portfolioCategoryAutocompleteSuggester( $query ) {
		...
		if ( is_array( $post_meta_infos ) && ! empty( $post_meta_infos ) ) {
			foreach ( $post_meta_infos as $value ) {
				...
				$data['label'] = ( ( strlen( $value['portfolio_category_title'] ) > 0 ) ? esc_html__( 'Category', 'entropia-core' ) . ': ' . $value['portfolio_category_title'] : '' );
				$results[]     = $data;
			}
		}
		...
		if ( ! empty( $query ) ) {
			...
			if ( is_object( $portfolio_category ) ) {
				...
				if ( ! empty( $portfolio_category_title ) ) {
					$portfolio_category_title_display = esc_html__( 'Category', 'entropia-core' ) . ': ' . $portfolio_category_title;
				}
		...
		if ( ! empty( $query ) ) {
			...
			if ( ! is_wp_error( $portfolio ) ) {
				...
				if ( ! empty( $portfolio_title ) ) {
					$portfolio_title_display = ' - ' . esc_html__( 'Title', 'entropia-core' ) . ': ' . $portfolio_title;
				}
				
				$portfolio_id_display = esc_html__( 'Id', 'entropia-core' ) . ': ' . $portfolio_id;
	...
	public function portfolioTagAutocompleteSuggester( $query ) {
		...
		if ( is_array( $post_meta_infos ) && ! empty( $post_meta_infos ) ) {
			foreach ( $post_meta_infos as $value ) {
				$data          = array();
				$data['value'] = $value['slug'];
				$data['label'] = ( ( strlen( $value['portfolio_tag_title'] ) > 0 ) ? esc_html__( 'Tag', 'entropia-core' ) . ': ' . $value['portfolio_tag_title'] : '' );
				$results[]     = $data;
			}
		}
		...
		if ( ! empty( $query ) ) {
			...
			if ( is_object( $portfolio_tag ) ) {
				...
				if ( ! empty( $portfolio_tag_title ) ) {
					$portfolio_tag_title_display = esc_html__( 'Tag', 'entropia-core' ) . ': ' . $portfolio_tag_title;
				}
