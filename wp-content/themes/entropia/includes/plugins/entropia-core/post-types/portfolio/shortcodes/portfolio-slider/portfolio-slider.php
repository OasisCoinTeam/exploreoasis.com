...
class PortfolioSlider implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Portfolio Slider', 'entropia-core' ),
					'base'     => $this->base,
					...
					'params'   => array(
						array(
							...
							'heading'     => esc_html__( 'Number of Portfolios Items', 'entropia-core' ),
							'admin_label' => true,
							'description' => esc_html__( 'Set number of items for your portfolio slider. Enter -1 to show all', 'entropia-core' )
						),
						array(
							'type'       => 'dropdown',
						...
						array(
							...
							'description' => esc_html__( 'Number of portfolios that are showing at the same time in slider (on smaller screens is responsive so there will be less items shown). Default value is Four', 'entropia-core' ),
							'save_always' => true
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'description' => esc_html__( 'Set image proportions for your portfolio slider.', 'entropia-core' ),
							'save_always' => true
						),
						array(
							'type'        => 'autocomplete',
						...
						array(
							...
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'entropia-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Navigation Skin', 'entropia-core' ),
							'value'      => array(
								esc_html__( 'Default', 'entropia-core' ) => '',
								esc_html__( 'Light', 'entropia-core' )   => 'light',
						...
						array(
							...
							'heading'    => esc_html__( 'Pagination Skin', 'entropia-core' ),
							'value'      => array(
								esc_html__( 'Default', 'entropia-core' ) => '',
								esc_html__( 'Light', 'entropia-core' )   => 'light',
								esc_html__( 'Dark', 'entropia-core' )    => 'dark'
						...
						array(
							...
							'heading'     => esc_html__( 'Pagination Position', 'entropia-core' ),
							'value'       => array(
								esc_html__( 'Below Slider', 'entropia-core' ) => 'below-slider',
								esc_html__( 'On Slider', 'entropia-core' )    => 'on-slider'
							),
							'save_always' => true,
							'dependency'  => array( 'element' => 'enable_pagination', 'value' => array( 'yes' ) ),
							'group'       => esc_html__( 'Slider Settings', 'entropia-core' )
