<?php
$masonry_classes   = '';
$number_of_columns = entropia_edge_get_meta_field_intersect( 'portfolio_single_masonry_columns_number' );
if ( ! empty( $number_of_columns ) ) {
	$masonry_classes .= ' edgtf-' . $number_of_columns . '-columns';
}
$space_between_items = entropia_edge_get_meta_field_intersect( 'portfolio_single_masonry_space_between_items' );
...
<div class="edgtf-ps-image-holder edgtf-grid-list edgtf-grid-masonry-list edgtf-fixed-masonry-items edgtf-disable-bottom-space <?php echo esc_attr( $masonry_classes ); ?>">
	<div class="edgtf-ps-image-inner edgtf-outer-space edgtf-masonry-list-wrapper">
		...
		<?php
		$media = entropia_core_get_portfolio_single_media(true);
...
<div class="edgtf-grid-row">
	<div class="edgtf-grid-col-8">
		<?php entropia_core_get_cpt_single_module_template_part('templates/single/parts/content', 'portfolio', $item_layout); ?>
	</div>
