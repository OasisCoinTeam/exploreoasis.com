...
class TeamList implements Lib\ShortcodeInterface {
    ...
    public function vcMap() {
	    if(function_exists('vc_map')) {
		    vc_map(
		    	array(
				    'name'                      => esc_html__( 'Team List', 'entropia-core' ),
				    'base'                      => $this->getBase(),
				    ...
				    'params'                    => array(
					    ...
					    array(
						    ...
						    'heading'     => esc_html__( 'Show Only Members with Listed IDs', 'entropia-core' ),
						    'settings'    => array(
							    'multiple'      => true,
							    'sortable'      => true,
							    'unique_values' => true
	...
	public function render( $atts, $content = null ) {
		...
		$html = entropia_core_get_cpt_shortcode_module_template_part( 'team', 'team-list', 'team-holder', '', $params, $additional_params );
