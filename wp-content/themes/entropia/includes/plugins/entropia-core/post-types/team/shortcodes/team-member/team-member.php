...
class TeamMember implements Lib\ShortcodeInterface {
    ...
    public function vcMap() {
        if(function_exists('vc_map')) {
	        vc_map( array(
			        'name'                      => esc_html__( 'Team Member', 'entropia-core' ),
			        'base'                      => $this->getBase(),
			        ...
			        'params'                    => array(
                        array(
                            ...
                            'heading'     => esc_html__('Team Layout', 'entropia-core'),
                            'value'       => array(
                        ...
                        array(
					        ...
					        'heading'    => esc_html__( 'Select Team Member', 'entropia-core' ),
					        'settings'   => array(
						        'sortable'      => true,
						        'unique_values' => true
					        ),
    ...
    public function render($atts, $content = null) {
        ...
        $html = entropia_core_get_cpt_shortcode_module_template_part('team', 'team-member', $params['team_member_layout'], '', $params);
