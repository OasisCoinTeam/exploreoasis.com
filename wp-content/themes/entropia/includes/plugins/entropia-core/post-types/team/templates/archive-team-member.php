...
<div class="edgtf-container edgtf-default-page-template">
	...
	<div class="edgtf-container-inner clearfix">
		<?php
			...
			$entropia_taxonomy = !empty($entropia_taxonomy_id) ? get_term_by( 'id', $entropia_taxonomy_id, 'team-category' ) : '';
			$entropia_taxonomy_slug = !empty($entropia_taxonomy) ? $entropia_taxonomy->slug : '';
		
			entropia_core_get_team_category_list($entropia_taxonomy_slug);
		?>
	</div>
