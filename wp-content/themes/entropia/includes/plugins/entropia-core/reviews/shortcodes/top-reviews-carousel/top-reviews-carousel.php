...
namespace EntropiaCore\CPT\Shortcodes\TopReviewsCarousel;

use EntropiaCore\Lib\ShortcodeInterface;

class TopReviewsCarousel implements ShortcodeInterface {
	private $base;
	
	public function __construct() {
		$this->base = 'entropia_core_top_reviews_carousel';
	...
	public function vcMap() {
		$criteria_ratings = entropia_core_rating_criteria_for_vc();
		
		vc_map(
			array(
				'name'                      => esc_html__( 'Top Reviews Carousel', 'entropia-core' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					...
					array(
						...
						'heading'     => esc_html__( 'Number of Reviews', 'entropia-core' ),
						'description' => esc_html__( 'Leave empty for all', 'entropia-core' )
					),
					array(
						'type'        => 'dropdown',
						'param_name'  => 'review_criteria',
						'heading'     => esc_html__( 'Order by Review Criteria', 'entropia-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		return entropia_core_get_module_shortcode_template_part( 'reviews', 'top-reviews-carousel', 'top-reviews-carousel', '', $params );
	}
