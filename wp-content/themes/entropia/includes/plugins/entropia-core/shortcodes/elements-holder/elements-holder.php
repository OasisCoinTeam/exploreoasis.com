...
class ElementsHolder implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'      => esc_html__( 'Elements Holder', 'entropia-core' ),
					'base'      => $this->base,
					...
					'params'    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Holder Full Height', 'entropia-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Columns', 'entropia-core' ),
							'value'       => array(
								esc_html__( '1 Column', 'entropia-core' )  => 'one-column',
								esc_html__( '2 Columns', 'entropia-core' ) => 'two-columns',
								esc_html__( '3 Columns', 'entropia-core' ) => 'three-columns',
								esc_html__( '4 Columns', 'entropia-core' ) => 'four-columns',
								esc_html__( '5 Columns', 'entropia-core' ) => 'five-columns',
								esc_html__( '6 Columns', 'entropia-core' ) => 'six-columns'
							),
							'save_always' => true
						),
						array(
							...
							'heading'    => esc_html__( 'Items Float Left', 'entropia-core' ),
						...
						array(
							...
							'value'       => array(
								...
								esc_html__( 'Never', 'entropia-core' )        => 'never'
							),
						...
						array(
							...
							'heading'     => esc_html__( 'Choose Alignment In Responsive Mode', 'entropia-core' ),
							'value'       => array(
								esc_html__( 'Default', 'entropia-core' ) => '',
							...
							'description' => esc_html__( 'Alignment When Items are in One Column', 'entropia-core' ),
							'save_always' => true
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = '<div ' . entropia_edge_get_class_attribute( $holder_classes ) . ' ' . entropia_edge_get_inline_attr( $holder_styles, 'style' ) . '>';
