<?php
namespace EntropiaCore\CPT\Shortcodes\GalleryBlocks;
...
class GalleryBlocks implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Gallery Blocks', 'entropia-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'description' => esc_html__( 'Select images from media library. The first image you upload will be set as the featured image if you set Featured Image Size.', 'entropia-core' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'featured_image_size',
							'heading'     => esc_html__( 'Featured Image Size', 'entropia-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Enable Lightbox Functionality', 'entropia-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		$html = entropia_core_get_shortcode_module_template_part( 'templates/gallery-blocks', 'gallery-blocks', '', $params );
