<?php
namespace EntropiaCore\CPT\Shortcodes\SectionTitle;
...
class SectionTitle implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Section Title', 'entropia-core' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						...
						array(
							...
							'value'       => array(
								...
								esc_html__( 'Two Columns', 'entropia-core' ) => 'two-columns'
							),
							'save_always' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Title - Text Position', 'entropia-core' ),
							'value'       => array(
								esc_html__( 'Title Left - Text Right', 'entropia-core' ) => 'title-left',
								esc_html__( 'Title Right - Text Left', 'entropia-core' ) => 'title-right'
							),
							'save_always' => true,
						...
						array(
							...
							'heading'     => esc_html__( 'Space Between Columns', 'entropia-core' ),
							'value'       => array(
								esc_html__( 'Normal', 'entropia-core' ) => 'normal',
								esc_html__( 'Small', 'entropia-core' )  => 'small',
								esc_html__( 'Tiny', 'entropia-core' )   => 'tiny'
							),
							'save_always' => true,
							'dependency'  => array( 'element' => 'type', 'value' => array( 'two-columns' ) )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'position',
							'heading'     => esc_html__( 'Horizontal Position', 'entropia-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Holder Side Padding (px or %)', 'entropia-core' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'title',
						...
						array(
							...
							'group'       => esc_html__( 'Title Style', 'entropia-core' )
						),
						array(
							'type'       => 'colorpicker',
						...
						array(
							...
							'heading'     => esc_html__( 'Words with Bold Font Weight', 'entropia-core' ),
							'description' => esc_html__( 'Enter the positions of the words you would like to display in a "bold" font weight. Separate the positions with commas (e.g. if you would like the first, second, and third word to have a light font weight, you would enter "1,2,3")', 'entropia-core' ),
							'dependency'  => array( 'element' => 'title', 'not_empty' => true ),
							'group'       => esc_html__( 'Title Style', 'entropia-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Words with Light Font Weight', 'entropia-core' ),
							'description' => esc_html__( 'Enter the positions of the words you would like to display in a "light" font weight. Separate the positions with commas (e.g. if you would like the first, third, and fourth word to have a light font weight, you would enter "1,3,4")', 'entropia-core' ),
							'dependency'  => array( 'element' => 'title', 'not_empty' => true ),
							'group'       => esc_html__( 'Title Style', 'entropia-core' )
						),
						array(
							...
							'description' => esc_html__( 'Enter the position of the word after which you would like to create a line break (e.g. if you would like the line break after the 3rd word, you would enter "3")', 'entropia-core' ),
							'dependency'  => array( 'element' => 'title', 'not_empty' => true ),
							'group'       => esc_html__( 'Title Style', 'entropia-core' )
						),
						array(
						...
						array(
							...
							'group'       => esc_html__( 'Text Style', 'entropia-core' )
						),
						array(
							'type'       => 'colorpicker',
						...
						array(
							...
							'heading'    => esc_html__( 'Text Font Size (px)', 'entropia-core' ),
							'dependency' => array( 'element' => 'text', 'not_empty' => true ),
							'group'      => esc_html__( 'Text Style', 'entropia-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Text Line Height (px)', 'entropia-core' ),
							'dependency' => array( 'element' => 'text', 'not_empty' => true ),
							'group'      => esc_html__( 'Text Style', 'entropia-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Text Font Weight', 'entropia-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		$html = entropia_core_get_shortcode_module_template_part( 'templates/section-title', 'section-title', '', $params );
	...
	private function getTextStyles( $params ) {
		...
		if ( ! empty( $params['text_font_size'] ) ) {
			$styles[] = 'font-size: ' . entropia_edge_filter_px( $params['text_font_size'] ) . 'px';
		}
		
		if ( ! empty( $params['text_line_height'] ) ) {
			$styles[] = 'line-height: ' . entropia_edge_filter_px( $params['text_line_height'] ) . 'px';
		}
		...
		if ( $params['text_margin'] !== '' ) {
			$styles[] = 'margin-top: ' . entropia_edge_filter_px( $params['text_margin'] ) . 'px';
		}
