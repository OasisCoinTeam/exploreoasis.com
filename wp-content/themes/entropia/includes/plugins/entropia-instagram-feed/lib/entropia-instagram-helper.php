...
/**
 * Class EntropiaInstagramHelper
 */
class EntropiaInstagramHelper {
	/**
	 * Generates HTML for given image from Instagram feed. Defines entropia_instagram_image_atts filter
	 *
	...
	public function getImageHTML( $image, $imageSize ) {
		...
		$imageAtts = apply_filters( 'entropia_instagram_image_atts',
			array(
				'class'  => $imageSize,
