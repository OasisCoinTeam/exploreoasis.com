...
if ( $row_content_width === 'grid' ) {
	$edgtf_row_wrapper_start .= '<div class="edgtf-row-grid-section-wrapper ' . esc_attr( $grid_row_classes ) . '" ' . esc_attr( $grid_row_datas ) . ' ' . entropia_edge_get_inline_style( $edgtf_grid_row_styles ) . '><div class="edgtf-row-grid-section">';
	$edgtf_row_wrapper_end   .= '</div></div>';
}

$edgtf_after_wrapper_open   = apply_filters('entropia_edge_vc_after_wrapper_open', '', $atts);
$edgtf_before_wrapper_close = apply_filters('entropia_edge_vc_before_wrapper_close', '', $atts);
$css_classes                = apply_filters('entropia_edge_vc_css_classes', $css_classes, $atts);
...
$output .= '<div ' . implode( ' ', $wrapper_attributes ) . ' ' . entropia_edge_get_inline_style( $edgtf_vc_row_styles ) . '>';
